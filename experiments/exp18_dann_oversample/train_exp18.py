...
from processor_exp18 import part_attention_vit_do_train_with_amp_exp17
from sampler_exp18 import CameraOversampleSampler
...
LAMBDA_DANN      = 0.3
NUM_CAMERAS      = 4
N_C004_PER_BATCH = 4   # force 4 c004-capable identities per batch (out of 8 total)
