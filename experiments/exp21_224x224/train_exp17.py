"""
Train script for exp17_dann_equalized.
...
Run from Part-Aware-Transformer-main directory:
    python /media/DiscoLocal/IPCV/UE-ReID/experiments/exp17_dann_equalized/train_exp17.py \
        --config_file /media/DiscoLocal/IPCV/UE-ReID/experiments/exp17_dann_equalized/config/train.yml
...
if __name__ == '__main__':
    ...
    logger.info("Experiment: exp17_dann_equalized")
